...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    assert Math.abs(f4.doubleValue() - 0.75) < 0.0001 : "Erreur : 0.75 attendu " + f4.doubleValue();

    // Test de la méthode doubleValue avec une fraction 1/2
    Fraction f6 = new Fraction(1, 2);
     assert Math.abs(f6.doubleValue() - 0.5) < 0.0001 : "Erreur : 0.5 attendu, " + f6.doubleValue();
